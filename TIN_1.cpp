...
cout<<"i am here";
 char* topfile=(argv[2]);     // topfile=topology.txt
 ...
 { k++;
     src_dest[i][0]=data[k++];                  //src_dest array save source and destination
     src_dest[i][1]=data[k++];
...
/////////////        checking with path1 //////////////////////////////////////
  ...
  for(int q=0;q<paths[src][dest].size()-1;++q)
  {
    ...
    for(int j=0;j<num_edges;++j)           //finding the capacity index corresponding to the given link
    {
